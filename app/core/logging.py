...
_EVENT_FRIENDLY: dict[str, str] = {
    ...
    "scheduler_eod_summary": "** EOD SUMMARY  date={date_ist}  trades={trades_today}  opened={trades_opened}  signals={signals_seen}  pnl={realized_pnl:.2f}  sqoff_closed={closed_in_square_off}",
